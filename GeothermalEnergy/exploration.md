...
We use geologic evidence from the surface and analyze rock samples to understand the formation of these different zones. Once geophysicists have sufficient information about the geology, they proceed to use geophysical instruments to explore the specific location. 
 ...
 ## How we explore
 ### Geochemistry
<!-- Information about geochemistry in exploration -->
...
Temperature Logs:
Temperature logs measure the temperature or temperature differences inside a well. This data gives information about the general geothermal gradient and thus helps to identify zones for geothermal production. The local change in temperature also contains informations about flow channels in the local surroundings of the well indicating (hydraulic) fractures and/or casing leaks.
 ...
 * Electromagnetics: Simliar to Seismics, electromagnetic methods use electromagnetic waves travelling in the subsurface. These can be generated by human made sources, but also stem from the solar wind interatting with the earths magnetic field and lightnings.
 ...
 #### Seismic (@Hagen)
<!-- PICTURES:  / Geophones /  GIF with wavefield data
...
<b>By the way:</b> Two of our researchers are working on this topic. By analysing the complete set of data recorded in a seismic survey, we try to recover more details of the underground. This helps us making geothermal cheaper and more easily accessible. </div>
...
<div class="alert alert-block alert-info">
<b>By the way:</b> Three of our researchers are working on this topic. By using modern inversion techniques, that combine more than one geophysical method, we can create an even better model of the underground. </div>
